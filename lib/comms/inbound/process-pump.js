module.exports = function(container) {
    if (container.logModuleLoading)
        ...
        bottle.factory('pump_1', require('./pump/1.js'))
        bottle.factory('pump_2', require('./pump/2.js'))
        bottle.factory('pump_4', require('./pump/4.js'))
        bottle.factory('pump_5', require('./pump/5.js'))
        bottle.factory('pump_6', require('./pump/6.js'))
        bottle.factory('pump_7', require('./pump/7.js'))
